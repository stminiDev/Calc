...
btn_0 = Button(btns_frame, text="0", foreground="black", width=22, height=3, bd=1, bg="#fff", cursor="hand2",
              command=lambda: btn_click(0)).grid(row=5, column=0, columnspan=2, padx=0, pady=2)
btn_1 = Button(btns_frame, text="1", foreground="black", width=10, height=3, bd=1, bg="#fff", cursor="hand2",
             command=lambda: btn_click(1)).grid(row=4, column=0, padx=1, pady=1)
btn_2 = Button(btns_frame, text="2", foreground="black", width=10, height=3, bd=1, bg="#fff", cursor="hand2",
             command=lambda: btn_click(2)).grid(row=4, column=1, padx=1, pady=1)

btn_3 = Button(btns_frame, text="3", foreground="black", width=10, height=3, bd=1, bg="#fff", cursor="hand2",
               command=lambda: btn_click(3)).grid(row=4, column=2, padx=1, pady=1)
btn_4 = Button(btns_frame, text="4", foreground="black", width=10, height=3, bd=1, bg="#fff", cursor="hand2",
              command=lambda: btn_click(4)).grid(row=3, column=0, padx=1, pady=1)
btn_5 = Button(btns_frame, text="5", foreground="black", width=10, height=3, bd=1, bg="#fff", cursor="hand2",
              command=lambda: btn_click(5)).grid(row=3, column=1, padx=1, pady=1)

btn_6 = Button(btns_frame, text="6", foreground="black", width=10, height=3, bd=1, bg="#fff", cursor="hand2",
             command=lambda: btn_click(6)).grid(row=3, column=2, padx=1, pady=1)
btn_7 = Button(btns_frame, text="7", foreground="black", width=10, height=3, bd=1, bg="#fff", cursor="hand2",
               command=lambda: btn_click(7)).grid(row=2, column=0, padx=1, pady=1)
btn_8 = Button(btns_frame, text="8", foreground="black", width=10, height=3, bd=1, bg="#fff", cursor="hand2",
               command=lambda: btn_click(8)).grid(row=2, column=1, padx=1, pady=1)
btn_9 = Button(btns_frame, text="9", foreground="black", width=10, height=3, bd=1, bg="#fff", cursor="hand2",
              command=lambda: btn_click(9)).grid(row=2, column=2, padx=1, pady=1)


btn_clr = Button(btns_frame, text="CLEAR", fg="black", width=33, height=3, bd=1, bg="#FFD6D6", cursor="hand2",
               command=lambda: btn_clear()).grid(row=1, columnspan=3,pady=1,padx=2)
btn_div = Button(btns_frame, text="%", fg="black", width=10, height=3, bd=1, bg="#E8E8E8", cursor="hand2",
             command=lambda: btn_click("/")).grid(row=1, column=3,padx=1, pady=1)
btn_mul = Button(btns_frame, text="x", fg="black", width=10, height=3, bd=1, bg="#E8E8E8", cursor="hand2",
              command=lambda: btn_click("*")).grid(row=2, column=3, padx=1, pady=1)
btn_sub = Button(btns_frame, text="-", fg="black", width=10, height=3, bd=1, bg="#E8E8E8", cursor="hand2",
             command=lambda: btn_click("-")).grid(row=3, column=3, padx=1, pady=1)
btn_add = Button(btns_frame, text="+", fg="black", width=10, height=3, bd=1, bg="#E8E8E8", cursor="hand2",
                 command=lambda: btn_click("+")).grid(row=4, column=3, padx=1, pady=1)
btn_dot = Button(btns_frame, text=".", fg="black", width=10, height=3, bd=1, bg="#fff", cursor="hand2",
             command=lambda: btn_click(".")).grid(row=5, column=2, padx=1, pady=1)
btn_eql = Button(btns_frame, text="=", fg="black", width=10, height=3, bd=1, bg="#FFD6D6", cursor="hand2",
